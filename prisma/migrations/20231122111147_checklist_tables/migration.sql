/*
  ...
  - Added the required column `certificateIssued` to the `Voyage` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Voyage" ADD COLUMN     "certificateIssued" TIMESTAMPTZ NOT NULL,
ADD COLUMN     "showcasePublished" TIMESTAMPTZ,
