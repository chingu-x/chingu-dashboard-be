...
describe('SprintsController', () => {
  ...
  const mockFormWithQuestionsResponse = createMockData.formWithQuestions(1, mockFormResponseMeeting);
  ...
  describe('getVoyagesAndSprints', () => {
    ...
    it('should return voyages with correct type structure', async () => {
      ...
      jest.spyOn(sprintsService, 'getVoyagesAndSprints').mockResolvedValue([mockVoyageResponse]);
  ...
  describe('createTeamMeeting', () => {
    ...
    it('should create a team meeting successfully', async () => {
      ...
      // Act
      const result = await sprintsController.createTeamMeeting(createMockData.request, teamId, sprintNumber, mockCreateMeetingDto);

      // Assert
      expect(result).toEqual(mockCreatedMeeting);
      expect(sprintsService.createTeamMeeting).toHaveBeenCalledWith(teamId, sprintNumber, mockCreateMeetingDto, mockRequest);
    });
  ...
  describe('updateTeamMeeting', () => {
    ...
    it('should update a team meeting successfully', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'updateTeamMeeting').mockResolvedValue(mockUpdatedMeeting);
    ...
    it('should handle partial updates', async () => {
      ...
      jest.spyOn(sprintsService, 'updateTeamMeeting').mockResolvedValue(partiallyUpdatedMeeting);
    ...
    it('should verify updated meeting data structure', async () => {
      ...
      // Act
      const result = await sprintsController.updateTeamMeeting(
        mockRequest, meetingId, mockUpdatedMeetingDto
      );
  ...
  describe('addMeetingAgenda', () => {
    ...
    it('should create an agenda item successfully', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'createMeetingAgenda').mockResolvedValue(mockCreatedAgenda);
    ...
    it('should create agenda with minimal required fields', async () => {
      ...
      jest.spyOn(sprintsService, 'createMeetingAgenda').mockResolvedValue(minimalCreatedAgenda);
  ...
  describe('updateMeetingAgenda', () => {
    ...
    it('should update an agenda item successfully', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'updateMeetingAgenda').mockResolvedValue(mockUpdatedAgenda);
    ...
    it('should handle partial updates', async () => {
      ...
      jest.spyOn(sprintsService, 'updateMeetingAgenda').mockResolvedValue(partiallyUpdatedAgenda);
    ...
    it('should update status to completed', async () => {
      ...
      jest.spyOn(sprintsService, 'updateMeetingAgenda').mockResolvedValue(completedAgenda);
  ...
  describe('deleteMeetingAgenda', () => {
    ...
    it('should delete an agenda item successfully', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'deleteMeetingAgenda').mockResolvedValue(mockDeletedAgenda);
    ...
    it('should verify deleted agenda data structure in response', async () => {
      ...
      // Act
      const result = await sprintsController.deleteMeetingAgenda(mockRequest, agendaId);
    ...
    it('should accept numeric string as agendaId', async () => {
      ...
      // Act
      const result = await sprintsController.deleteMeetingAgenda(mockRequest, 1);

      // Assert
      expect(result).toEqual(mockDeletedAgenda);
      expect(sprintsService.deleteMeetingAgenda).toHaveBeenCalledWith(1, mockRequest);
    });
    ...
    it('should delete completed agenda items', async () => {
      ...
      jest.spyOn(sprintsService, 'deleteMeetingAgenda').mockResolvedValue(completedAgenda);
      ...
      expect(sprintsService.deleteMeetingAgenda).toHaveBeenCalledWith(agendaId, mockRequest);
    });
  });
  describe('addMeetingFormResponse', () => {
    ...
    it('should call addMeetingFormResponse with correct parameters', async () => {
      ...
      const meetingId = 1;
      const formId = 1;
      jest.spyOn(sprintsService, 'addMeetingFormResponse').mockResolvedValue(mockFormResponseMeeting);

      // Act
      await sprintsController.addMeetingFormResponse(mockRequest, meetingId, formId);
    ...
    it('should verify service method is called exactly once', async () => {
      ...
      // Assert
      expect(sprintsService.addMeetingFormResponse).toHaveBeenCalledTimes(1);
    });
    ...
    it('should verify service method is called with numeric parameters', async () => {
      ...
      const meetingId = 1;
      const formId = 1;
      const spy = jest.spyOn(sprintsService, 'addMeetingFormResponse').mockResolvedValue(mockFormResponseMeeting);
  ...
  describe('getMeetingFormQuestionsWithResponses', () => {
    it('should have getMeetingFormQuestionsWithResponses function defined', () => {
      expect(sprintsController.getMeetingFormQuestionsWithResponses).toBeDefined();
    });

    it('should have sprintService.getMeetingFormQuestionsWithResponses defined', () => {
      expect(sprintsService.getMeetingFormQuestionsWithResponses).toBeDefined();
    });
    ...
    it('should call sprintsService.getMeetingFormQuestionsWithResponses with correct parameters', async () => {
      ...
      const meetingId = 1;
      const formId = 1;
      const mockFullFormResponse = createMockData.formWithQuestions(1, mockFormResponseMeeting);
      jest.spyOn(sprintsService, 'getMeetingFormQuestionsWithResponses').mockResolvedValue(mockFullFormResponse);

      // Act
      await sprintsController.getMeetingFormQuestionsWithResponses(meetingId, formId, mockRequest);

      // Assert
      expect(sprintsService.getMeetingFormQuestionsWithResponses).toHaveBeenCalledWith(
        meetingId,
        formId,
        mockRequest
      );
    ...
    it('should verify service method is called exactly once', async () => {
      ...
      jest.spyOn(sprintsService, 'getMeetingFormQuestionsWithResponses').mockResolvedValue(mockFormWithQuestionsResponse);

      // Act
      await sprintsController.getMeetingFormQuestionsWithResponses(meetingId, formId, mockRequest);

      // Assert
      expect(sprintsService.getMeetingFormQuestionsWithResponses).toHaveBeenCalledTimes(1);
    });
    ...
    it('should verify service method is called with numeric parameters', async () => {
      ...
      const meetingId = 1;
      const formId = 1;
      const spy = jest.spyOn(sprintsService, 'getMeetingFormQuestionsWithResponses')
    ...
    it('should verify service method handles different meetingIds', async () => {
      ...
      for (const meetingId of meetingIds) {
        await sprintsController.getMeetingFormQuestionsWithResponses(meetingId, formId, mockRequest);
        expect(spy).toHaveBeenCalledWith(meetingId, formId, mockRequest);
      }
    });
  });
  describe('updateMeetingFormResponse', () => {
    ...
    it('should call sprintsService.updateMeetingFormResponse with correct parameters', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'updateMeetingFormResponse').mockResolvedValue([mockUpdateMeetingFormResponse]);
      ...
      // Assert
      expect(sprintsService.updateMeetingFormResponse).toHaveBeenCalledWith(
        meetingId,
        formId,
        mockUpdateMeetingFormResponseDto,
        mockRequest
    ...
    it('should verify service method is called exactly once', async () => {
      ...
      // Assert
      expect(sprintsService.updateMeetingFormResponse).toHaveBeenCalledTimes(1);
    });

    it('should verify service method is called with numeric meetingId and formId', async () => {
      // Arrange
      const spy = jest.spyOn(sprintsService, 'updateMeetingFormResponse')
    ...
    it('should verify parameters are passed in correct order', async () => {
      ...
      // Assert
      const [firstParam, secondParam, thirdParam, fourthParam] = spy.mock.calls[0];
      expect(firstParam).toBe(meetingId);
      expect(secondParam).toBe(formId);
    ...
    it('should verify DTO is passed unmodified to service', async () => {
      ...
      expect(passedDto.responses?.[0].questionId).toBe(mockUpdateMeetingFormResponseDto.responses?.[0].questionId);
      expect(passedDto.responses?.[0].text).toBe(mockUpdateMeetingFormResponseDto.responses?.[0].text);
      expect(passedDto.responses?.[0].numeric).toBe(mockUpdateMeetingFormResponseDto.responses?.[0].numeric);
      expect(passedDto.responses?.[0].boolean).toBe(mockUpdateMeetingFormResponseDto.responses?.[0].boolean);
      expect(passedDto.responses?.[0].optionChoiceId).toBe(mockUpdateMeetingFormResponseDto.responses?.[0].optionChoiceId);
    });
  });
  describe('addCheckinFormResponse', () => {
    ...
    it('should call sprintsService.addCheckinFormResponse with correct parameters', async () => {
      ...
      jest.spyOn(sprintsService, 'addCheckinFormResponse').mockResolvedValue(mockCheckinResponse);

      // Act
      await sprintsController.addCheckinFormResponse(mockCreateCheckinFormDto);
    ...
    it('should verify service method is called exactly once', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'addCheckinFormResponse').mockResolvedValue({
        id: 1,
        voyageTeamMemberId: 1,
        sprintId: 1,
        responseGroupId: 5,
      ...
      // Assert
      expect(sprintsService.addCheckinFormResponse).toHaveBeenCalledTimes(1);
    });

    it('should verify DTO is passed unmodified to service', async () => {
      // Arrange
      const spy = jest.spyOn(sprintsService, 'addCheckinFormResponse')
        .mockResolvedValue({
          id: 1,
          voyageTeamMemberId: 1,
          sprintId: 1,
      ...
      expect(passedDto.voyageTeamMemberId).toBe(mockCreateCheckinFormDto.voyageTeamMemberId);
      expect(passedDto.responses).toEqual(mockCreateCheckinFormDto.responses);
    });
  });
  describe('getCheckinFormResponse', () => {
    ...
    it('should call sprintsService.getCheckinFormResponse with correct parameters', async () => {
      ...
      jest.spyOn(sprintsService, 'getCheckinFormResponse').mockResolvedValue([mockResponse]);

      // Act
      await sprintsController.getCheckinFormResponse(mockQuery);

      // Assert
      expect(sprintsService.getCheckinFormResponse).toHaveBeenCalledWith(mockQuery);
    });

    it('should verify service method is called exactly once', async () => {
      // Arrange
      jest.spyOn(sprintsService, 'getCheckinFormResponse').mockResolvedValue([]);

      // Act
      await sprintsController.getCheckinFormResponse(mockQuery);

      // Assert
      expect(sprintsService.getCheckinFormResponse).toHaveBeenCalledTimes(1);
    });
    ...
    it('should handle empty query parameters', async () => {
      ...
      // Assert
      expect(sprintsService.getCheckinFormResponse).toHaveBeenCalledWith(emptyQuery);
    });
    ...
    it('should handle partial query parameters', async () => {
      ...
      // Assert
      expect(sprintsService.getCheckinFormResponse).toHaveBeenCalledWith(partialQuery);
    });
  });
